...
function trocarTextoEpisodio4(){
    ...
    linkClassico.setAttribute("href","index.php?cod=404");
    imgClassico.setAttribute("src","./public/assets/imagens/ep4.png");
}
function trocarTextoEpisodio5(){
    ...
    linkClassico.setAttribute("href","index.php?cod=404");
    imgClassico.setAttribute("src","./public/assets/imagens/ep5.png");
...
function trocarTextoEpisodio6(){
    ...
    linkClassico.setAttribute("href","index.php?cod=404");
    imgClassico.setAttribute("src","./public/assets/imagens/ep6.png");
