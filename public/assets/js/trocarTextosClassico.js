...
// seleciona os botões 
const botaoEpisodio4=document.querySelector("#episodio4");
const botaoEpisodio5=document.querySelector("#episodio5");
const botaoEpisodio6=document.querySelector("#episodio6");
