...
function trocarTextoEpisodio1(){
    ...
    link.setAttribute("href","./paginas/episodios/episodio1.php");
    img.setAttribute("src","./assets/imagens/ep1.png");
}
...
function trocarTextoEpisodio2(){
    ...
    link.setAttribute("href","./paginas/episodios/episodio2.php");
    img.setAttribute("src","./assets/imagens/ep2.png");
}
...
function trocarTextoEpisodio3(){
    ...
    link.setAttribute("href","./paginas/episodios/episodio3.php");
    img.setAttribute("src","./assets/imagens/ep3.png");
}
