...
function trocarTextoEpisodio1(){
    ...
    link.setAttribute("href","index.php?cod=ep1");
    img.setAttribute("src","./public/assets/imagens/ep1.png");
}
...
function trocarTextoEpisodio2(){
    ...
    link.setAttribute("href","index.php?cod=ep2");
    img.setAttribute("src","./public/assets/imagens/ep2.png");
}
...
function trocarTextoEpisodio3(){
    ...
    link.setAttribute("href","index.php?cod=ep3");
    img.setAttribute("src","./public/assets/imagens/ep3.png");
}
